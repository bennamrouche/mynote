...
import alphaben.mynote.core.CONST;
import alphaben.mynote.core.event.LabelMouseEvent;
import alphaben.mynote.core.handlers.Handler;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String Password =  String.valueOf(txtPassword.getPassword());
       //************** < Valdiation >
        // here
       //************** < Valdiation >
       boolean res = Handler.getHandler().Login(userName, Password);
        if(res)
